...
router.get('/approved', sportController.getApprovedSportsWithTeams);
...
// Coach: Get team members
router.get('/coach-dashboard-team', authMiddleware, sportController.getApprovedSportsWithTeamsById);
