...
import { FileText, ClipboardList, Users, Calendar, UserCog } from "lucide-react";
    ...
    const cards = [
        {
            ...
            value: stats.news + stats.announcements,
...

        {
            ...
            value: stats.pendingSports + stats.pendingTeams,
