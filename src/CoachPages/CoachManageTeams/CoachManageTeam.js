                ...
                <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-2xl w-full max-w-2xl p-6 max-h-[90vh] overflow-y-auto shadow-2xl">
                        ...
                        <div className="border-t pt-4">
                            ...
                            <button onClick={handleAddMemberField} className="bg-green-100 text-green-700 px-4 py-2 rounded font-bold hover:bg-green-200 transition">+ Add Member</button>
                        </div>
